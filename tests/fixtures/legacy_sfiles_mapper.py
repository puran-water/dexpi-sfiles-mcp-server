"""FROZEN LEGACY: Bidirectional mapper between SFILES and DEXPI formats.

This is a frozen copy of src/converters/sfiles_dexpi_mapper.py from commit 672541b
(before Phase 1 migration). Used for baseline capture to detect future regressions.

DO NOT MODIFY - this preserves pre-migration behavior for equivalence testing.
"""
